...
def scrape():
    headers = {
        ...
        base_urls = {
            "picks": "https://www.oddstrader.com/nfl/picks/",
            "props": "https://www.oddstrader.com/nfl/player-props/"
        }
        ...
        with open("nfl_odds_results.json", "w") as f:
