...
def scrape():
    headers = {
        ...
        base_urls = {'picks': 'https://www.oddstrader.com/ncaa-college-football/picks/', 'props': 'https://www.oddstrader.com/ncaa-college-football/player-props/'}
        ...
        with open("ncaaf_odds_results.json", "w") as f:
